...
export default function DonationSettings() {
  return (
    <div className="space-y-6">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-slate-900 mb-2">Donation Payment Settings</h2>
        <p className="text-slate-600">Configure payment gateways for receiving donations.</p>
      </div>
      ...
      <Tabs defaultValue="razorpay" className="w-full">
        ...
        <TabsContent value="razorpay" className="mt-4">
          <RazorpaySettings configType="donations" />
        </TabsContent>

        <TabsContent value="paypal" className="mt-4">
          <PayPalSettings configType="donations" />
        </TabsContent>
      </Tabs>
    </div>
  );
