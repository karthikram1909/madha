...
//                 <Route path="/UserBuyBooks" element={<UserBuyBooks />} />
...
function Pages() {
    return (
        ...
        <Route path="/BuyBooksformobile" element={<BuyBooksformobile />} />
        <Route path="/Aboutformobileview" element={<Aboutformobileview />} />
